...
/*    var domainMax = ["Cases",60000,"Deaths",500, "Recovered", 50000, "Pop",100];*/
    ...
    } else if (expressed == "Pop") {
     yScale.domain([0,100])
    } else if (expressed == "Cases") {
     yScale.domain([0,65000])
 };
    ...
    function setMap() {
        ...
        function ready (error, csvData, othercountries, centralasia) {
            ...
            console.log(csvData)//Central Asia Covid Data 
            console.log(othercountries)//Topojson of Surrounding Countries
            console.log(centralasia)//Central Asia Boundary with joined csv data
